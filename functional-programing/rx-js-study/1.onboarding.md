...
### Observables Are Composable (전체적으로 이해가 안됨. Java Futures 는 순서 교체가 가능한 Iterable 개념으로 짐작함.)
...
## 참고
  - 인프런 얄코-자바스크립트-reactivex 강의
   - (reactiveX 공식 도큐먼트) https://reactivex.io/documentation/ko/observable.html